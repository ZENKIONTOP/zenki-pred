...
@tree.command(name = 'mines', description='bloxflip predictor')
async def mines(interaction: discord.Interaction, bet_amt: int, round_id : str):
    if len(round_id) == 36:
        ...
        em.set_footer(text='MADE BY ZENKI')
...
client.run('MTIyMDAwNDcxNzY1NzE5ODU5Mg.GwF-_z.ojeygkIsSBFdhVmv4_5w2DZNp0eMtjHwJzhy2M')
